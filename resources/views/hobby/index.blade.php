                        ...
                        <ul class="list-group">
                            @foreach($hobbies as $hobby)
                                <li class="list-group-item">
                                    ...
                                    @if(file_exists('img/users/' . $hobby->user->id . '_thumb.jpg')) <!-- Note: Không có "/" trước img -->                                   
                                        <a href="/user/{{ $hobby->user->id }}"><img class="rounded" src="/img/users/{{$hobby->user->id}}_thumb.jpg"></a> <!-- Note: Có "/" trước img -->                                        
                                    @endif
                                    </span>
                                    @auth
